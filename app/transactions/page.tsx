              ...
              >
                ...
                <div className={`relative h-56 w-full overflow-hidden flex items-center justify-center ${transaction.isLogo ? 'bg-white' : 'bg-muted'}`}>
                  <Image
                    ...
                    fill
                    className={transaction.isLogo ? 'object-contain px-8 py-6 transition-transform duration-300 group-hover:scale-110' : 'object-cover transition-transform duration-500 group-hover:scale-105'}
                  />
