...
export default function TransactionsPage() {
  const transactions = [
    ...
    },
    {
      ...
      acquirerLocation: "Nepal",
      dealValue: "",
      image: "/images/sunfarmer-logo.png",
              ...
              >
                ...
                <div className={`relative h-56 w-full overflow-hidden flex items-center justify-center ${transaction.isLogo ? 'bg-white' : 'bg-muted'}`}>
                  <Image
                    ...
                    fill
                    className={transaction.isLogo ? 'object-contain p-4 transition-transform duration-300 group-hover:scale-110' : 'object-cover transition-transform duration-500 group-hover:scale-105'}
                  />
